<%@ Page Title="" Language="C#" MasterPageFile="~/HomeAdministrador.Master" AutoEventWireup="true" CodeBehind="HomeAdministrador.aspx.cs" Inherits="Proyecto.HomeAdministrador1" %>
...
<div style="position: absolute; z-index:10;width: 18rem; right:-920px; top:-2px" class="card" >
   ...
   <br /><br />
    ...
    <center>
<a href="ManualAdministrador.pdf" download="Manual.pdf" class="btn btn-primary">Descargar</a>
    </center>
  </div>
</div>
