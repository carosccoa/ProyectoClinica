<%@ Page Title="" Language="C#" MasterPageFile="~/HomePaciente.Master" AutoEventWireup="true" CodeBehind="HomePaciente.aspx.cs" Inherits="Proyecto.HomePaciente1" %>
...
<div style="position: absolute; z-index:10;width: 18rem; right:-920px; top:-2px" class="card" >
   ...
   <br /><br />
    ...
    <center>
<a href="ManualPaciente.pdf" download="Manual.pdf" class="btn btn-primary">Descargar</a>
    </center>
  </div>
</div>
